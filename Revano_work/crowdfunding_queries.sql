SELECT company_name, project_description, goal, pledged, (pledged / goal) AS success_ratio FROM campaign ORDER BY success_ratio DESC LIMIT 10;

SELECT company_name, goal, pledged, backers_count
FROM campaign WHERE pledged < goal AND backers_count < 50
